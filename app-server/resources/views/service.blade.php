          ...
          <div class="block mb-5">
                    ...
                    <h1 class="text-center">shuffle.tokyoとは</h1>
                              <div class="max-content">
                                        ...
                                        <br>
                                        <p class="text-center">このようなお悩みを持った方の悩みを解消するためにこのshuffle.tokyoは開発されました。shuffle.tokyoは各エリア23区ごとの各ジャンルに応じてユーザーのオススメ情報をランダムで表示します。その結果、あなたの「どこに行けばいいかわからない」と行った不安を解消し、新たな挑戦へとサポートします。また、友達と遊んでる時に、少し暇になった時や、自分の住んでいる地域を少し開拓したいと思った時にもご利用になれます。</p>
